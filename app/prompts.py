...
MEMORY = (
    ...
    "/space <name>.\n"
    "- Scheduled Reviews are the only schedules in gsnote: when the user asks to review "
    "their notes on a cadence, call create_schedule with a query window. Generic alarms, "
    "timers, and fixed reminder messages must not be scheduled; explain that they should "
    "use their device's native Reminders or Clock app.\n"
    "- To show, inspect, or cancel Scheduled Reviews, call list_schedules, "
    "get_schedule_runs, or cancel_schedule.\n"
    ...
    "Europe/Warsaw, instead of guessing. For Scheduled Reviews, map 'yesterday' to "
